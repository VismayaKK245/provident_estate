...
class MobileFirstHorizontal extends StatefulWidget {
  const MobileFirstHorizontal({super.key});

  @override
  State<MobileFirstHorizontal> createState() => ___MobileFirstHorizontal();
}

class ___MobileFirstHorizontal extends State<MobileFirstHorizontal> {
